 ...
 * Presenta la información organizada por secciones: estudiante, datos de pre-inscripción y estado.
 */
...
interface PreEnrollmentViewModalProps {
  ...
  onClose: () => void;
  /** Función opcional para abrir el modo de edición desde la vista de detalles */
  onEdit?: (item: PreEnrollmentRowData) => void;
  /** El registro de pre-inscripción a visualizar */
  item: PreEnrollmentRowData | null;
}

/**
 * Componente PreEnrollmentViewModal.
 * 
