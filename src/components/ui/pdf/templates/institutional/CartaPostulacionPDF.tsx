...
const styles = StyleSheet.create({
  ...
  firmaContainer: { marginTop: 40, flexDirection: 'row', justifyContent: 'space-between' },
  firmaLinea: { width: '45%', textAlign: 'center', fontSize: 10 },
  firmaRaya: { marginTop: 40, borderTop: '1 solid black', width: '100%', marginBottom: 5 },
});
...
export function CartaPostulacionPDF({ data, textos }: Props) {
  const cuerpo = renderDocumentText(textos.cuerpo || '', {
    ...
    estudianteTelefono: data.estudiante.telefono || '',
    estudianteEmail: data.estudiante.email || '',
    ...
    tutorInstitucionalNombre: data.tutorInstitucional ? formatNombreCompleto(data.tutorInstitucional) : '________________________',
  });
