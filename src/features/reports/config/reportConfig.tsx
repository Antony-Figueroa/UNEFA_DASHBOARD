...
export interface ReportConfigEntry {
  ...
  subtitle: string;
  type: 'pdf' | 'excel';
  loadData: (periodId?: number, careerId?: number, page?: number, limit?: number) => Promise<{ data: any[]; meta?: any }>;
...
export const reportConfig: Record<Exclude<ReportType, "">, ReportConfigEntry> = {
  ...
  "tutores-academicos": {
    ...
    type: "excel",
    loadData: async (periodId, careerId, page, limit) => {
      const response = await reportsService.getTutorsAcademicReport(periodId, careerId, page, limit);
  ...
  "resumen-pasantias": {
    ...
    type: "excel",
    loadData: async (periodId, careerId, page, limit) => {
      const response = await reportsService.getResumenPasantiasReport(periodId, careerId, page, limit);
      return { data: response?.data || [], meta: response?.meta };
    },
    pdfTemplate: () => <></>,
    columns: [
  ...
  "relacion-empresas": {
    ...
    type: "excel",
    loadData: async (periodId, careerId, page, limit) => {
      const response = await reportsService.getRelacionEmpresas(periodId, careerId, page, limit);
      return { data: response?.data || [], meta: response?.meta };
    },
    columns: [
      { header: "Región", accessor: "region" },
  ...
  "distribucion-tutores": {
    ...
    type: "excel",
    loadData: async (periodId, careerId, page, limit) => {
      const response = await reportsService.getDistribucionTutores(periodId, careerId, page, limit);
      return { data: response?.data || [], meta: response?.meta };
    },
    columns: [
      { header: "N°", accessor: "nro", className: "w-12 text-center" },
  ...
  "distribucion-tutores-v2": {
    ...
    type: "excel",
    loadData: async (periodId, careerId, page, limit) => {
      const response = await reportsService.getDistribucionTutoresV2(periodId, careerId, page, limit);
      return { data: response?.data || [], meta: response?.meta };
    },
    columns: [
      { header: "N°", accessor: "nro", className: "w-12 text-center" },
