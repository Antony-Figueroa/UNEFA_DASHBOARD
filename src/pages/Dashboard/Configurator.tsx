...
const WidgetIcon = ({ icon, color }: { icon: string; color?: string }) => {
  ...
  const strokeColor = `rgba(from ${accent} r g b / 0.8)`;
  ...
  switch (icon) {
    ...
    case 'pie-chart':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" /><path strokeLinecap="round" strokeLinejoin="round" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" /></svg>;
    case 'check-circle':
    ...
    case 'clock':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>;
    case 'briefcase':
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 max-w-lg">
              ...
              Arrastrá los widgets activos para reordenarlos.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {activeWidgets.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-14 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/50">
              ...
              <p className="mt-3 text-xs text-gray-400 dark:text-gray-500 text-center">
                Arrastrá los widgets para reordenarlos · Usá el color y tamaño para personalizar
              </p>
            </div>
