  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center text-text-primary dropdown-toggle dark:text-text-tertiary transition-all duration-200"
      >
      ...
      >
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-border-light dark:border-white/10">
          <li>
            <DropdownItem
              ...
              tag="a"
              to="/profile"
              className="flex items-center gap-3 px-3 py-2 font-medium text-text-primary rounded-lg group text-theme-sm hover:bg-brand-500 hover:text-white dark:text-text-tertiary dark:hover:bg-brand-500 dark:hover:text-white"
            >
              <svg
                className="fill-text-secondary group-hover:fill-white dark:fill-text-tertiary dark:group-hover:fill-white icon-md"
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
        ...
        <button
          ...
          className="flex items-center w-full gap-3 px-3 py-2 mt-3 font-medium rounded-lg text-text-primary group text-theme-sm hover:bg-brand-500 hover:text-white dark:text-text-tertiary dark:hover:bg-brand-500 dark:hover:text-white"
        >
          <svg
            className="fill-text-secondary group-hover:fill-white dark:group-hover:fill-white icon-md"
            viewBox="0 0 24 24"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
