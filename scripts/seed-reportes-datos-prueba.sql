...
WHERE c.CAREER_CODE IN ('INF', 'ENF', 'DES', 'CIV', 'MIC')
  AND t.NAME IN ('COMUNITARIA', 'HOSPITALARIA', 'ÚNICA');
...
('EMPRESA AGROINDUSTRIAL PORTUGUESA C.A.', 'Zona Industrial, Araure', '02551122334', 'ÚNICA', 'PORTUGUESA', 'PORTUGUESA', 'ACARIGUA', NOW(), 'PRIVADA', 1, 'J-34567890-1', 'EAP-001'),
...
WHERE (i.INSTITUTION_ID = 1 AND t.NAME IN ('HOSPITALARIA'))
   ...
   OR (i.INSTITUTION_ID = 3 AND t.NAME IN ('ÚNICA'))
...
FROM t_students s, t_internship_type t, t_career c
WHERE s.STUDENTS_CI = 'V-23456789' AND t.NAME = 'ÚNICA' AND c.CAREER_CODE = 'INF';
...
FROM t_students s, t_internship_type t, t_career c
WHERE s.STUDENTS_CI = 'V-67890123' AND t.NAME = 'ÚNICA' AND c.CAREER_CODE = 'CIV';
...
FROM t_students s, t_internship_type t, t_career c
WHERE s.STUDENTS_CI = 'V-11111111' AND t.NAME = 'ÚNICA' AND c.CAREER_CODE = 'CIV';
...
FROM t_students s, t_internship_type t, t_career c
WHERE s.STUDENTS_CI = 'V-44444444' AND t.NAME = 'ÚNICA' AND c.CAREER_CODE = 'CIV';
