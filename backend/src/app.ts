...
import periodTypeDatesRoutes from './routes/period-type-dates.routes.js';
...
import graceConfigRoutes from './routes/grace-config.routes.js';
...
app.use('/api/period-type-dates', periodTypeDatesRoutes);
app.use('/api/academic-config', graceConfigRoutes);
