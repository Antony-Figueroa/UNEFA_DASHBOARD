          ...
          <Page size="A4" style={pdfStyles.page}>
            ...
            <View style={{ width: "100%" }}>
              <View style={[pdfStyles.row, pdfStyles.headerRow]}>
                <Text style={{ ...pdfStyles.cellCi, fontFamily: "Helvetica", fontWeight: "bold" as any }}>CI</Text>
                <Text style={{ ...pdfStyles.cellName, fontFamily: "Helvetica", fontWeight: "bold" as any }}>Nombre</Text>
                <Text style={{ ...pdfStyles.cellPhone, fontFamily: "Helvetica", fontWeight: "bold" as any }}>Teléfono</Text>
                <Text style={{ ...pdfStyles.cellEnrolled, fontFamily: "Helvetica", fontWeight: "bold" as any }}>Inscripto</Text>
              </View>
              {items.map((item, i) => (
