...
const PublicFooter: React.FC = () => {
  const resources = [
    { name: "Reglamento de Prácticas", path: "/docs/reglamento-practicas-profesionales.pdf" },
    { name: "Carta de Postulación", path: "/docs/carta-postulacion-pp.pdf" },
    { name: "Actas Evaluativas", path: "/docs/actas-evaluativas.pdf" },
    { name: "Estructura del Informe", path: "/docs/estructura-del-informe.pdf" },
    { name: "Guía Metodológica", path: "/docs/metodologia.pdf" },
    { name: "Guía de Prácticas", path: "/docs/practicas-profesionales.pdf" },
    { name: "Plan de la Patria 7T", path: "/docs/plan-patria-7t.pdf" },
    { name: "Constitución RBV", path: "/docs/constitucion-rbv.pdf" },
    { name: "Plan de la Patria 2019-2025", path: "/docs/plan-patria-2019-2025.pdf" },
    { name: "Formato de Membrete", path: "/docs/membrete.doc" },
    { name: "Anexo: Portada", path: "/docs/anexo-k-portada.doc" },
  ];
