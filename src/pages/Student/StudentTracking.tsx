...
export default function StudentTracking() {
  ...
  if (loading) {
    return (
      <>
        <PageMeta title="Mi Seguimiento | UNEFA" description="Seguimiento de práctica profesional" />
        <PageBreadcrumb pageTitle="Mi Seguimiento" />
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-text-secondary dark:text-text-tertiary mt-1">
            Consultá el progreso y detalle de tu práctica profesional
          </p>
        </div>
