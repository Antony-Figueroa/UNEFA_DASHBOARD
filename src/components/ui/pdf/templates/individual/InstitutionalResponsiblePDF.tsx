...
export const InstitutionalResponsiblePDF: React.FC<InstitutionalResponsiblePDFProps> = ({ data }) => {
  ...
  return (
    <Document title={`Ficha de Responsable - ${responsible.firstName} ${responsible.lastName}`}>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Ficha de Responsable Institucional</Text>
          <Text style={styles.subtitle}>Enlace con Institución</Text>
        </View>
        ...
        <View style={styles.footer} fixed>
          <View style={styles.footerLeft}>
            <Image
              src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://unefa.edu.ve/validar?cedula=${responsible.identificationPrefix}-${responsible.identificationNumber}`}
