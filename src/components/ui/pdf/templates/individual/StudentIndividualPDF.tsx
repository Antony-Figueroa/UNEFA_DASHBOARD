...
interface StudentIndividualPDFProps {
  data: Student | StudentRowData;
}

export const StudentIndividualPDF: React.FC<StudentIndividualPDFProps> = ({ data }) => {
  const student = data;
  ...
  return (
    <Document title={`Ficha de Estudiante - ${student.firstName} ${student.lastName}`}>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.title}>Ficha de Estudiante</Text>
          <Text style={styles.subtitle}>Registro de Prácticas Profesionales</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoGrid}>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoValue}>{student.middleName || "-"}</Text>
            </View>
            <View style={styles.infoItem}>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoValue}>{student.secondLastName || "-"}</Text>
            </View>
            <View style={styles.infoItem}>
              <Text style={styles.infoLabel}>Sexo</Text>
              <Text style={styles.infoValue}>{student.sex}</Text>
            </View>
            <View style={styles.infoItem}>
              <Text style={styles.infoLabel}>Estado Civil</Text>
              <Text style={styles.infoValue}>{student.civilStatus}</Text>
            </View>
            <View style={styles.infoItem}>
            ...
            <View style={styles.infoItemFull}>
              <Text style={styles.infoLabel}>Dirección de Habitación</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoGrid}>
            ...
            <View style={styles.infoItem}>
              <Text style={styles.infoLabel}>Rango Militar</Text>
              <Text style={styles.infoValue}>{student.militaryRank}</Text>
            </View>
            <View style={styles.infoItem}>
              <Text style={styles.infoLabel}>¿Trabaja?</Text>
              <Text style={styles.infoValue}>{student.works}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.statusContainer}>
          <View style={styles.statusRow}>
            <View>
              ...
              <View style={[styles.statusBadge, student.status ? styles.statusBadgeActive : styles.statusBadgeInactive]}>
                <Text style={[styles.statusText, student.status ? styles.statusTextActive : styles.statusTextInactive]}>
            ...
            <View style={{ alignItems: "flex-end" }}>
              ...
              <Text style={styles.infoValue}>
                {typeof student.enrollmentDate === "string" 
                  ...
                  : new Date(student.enrollmentDate).toLocaleDateString("es-VE")}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.footer} fixed>
          <View style={styles.footerLeft}>
            <Image
              src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://unefa.edu.ve/validar?cedula=${student.identificationPrefix}-${student.identificationNumber}`}
...
export default StudentIndividualPDF;
