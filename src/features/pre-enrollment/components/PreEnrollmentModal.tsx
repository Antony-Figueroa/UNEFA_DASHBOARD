        ...
        <form id="pre-enrollment-form" onSubmit={handleSubmit(onSubmit)} className="space-y-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-5 sm:p-6 border border-border-light dark:border-white/10 shadow-sm">
            <div className="flex items-center gap-2 mb-5">
              ...
              <h3 className="text-base font-semibold text-text-primary dark:text-white">Datos del Estudiante</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {/* Cédula */}
            <div className="md:col-span-1">
              <label className="mb-2 block text-black dark:text-white font-medium text-sm">Cédula *</label>
...
setValue("identificationNumber", student.identificationNumber);
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-5 sm:p-6 border border-border-light dark:border-white/10 shadow-sm">
            <div className="flex items-center gap-2 mb-5">
              ...
              <h3 className="text-base font-semibold text-text-primary dark:text-white">Datos Académicos</h3>
            </div>
