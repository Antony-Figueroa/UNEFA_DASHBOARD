    ...
    <section id="mision-vision" className="py-20 bg-white dark:bg-bg-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Misión */}
          <div className="relative p-8 rounded-3xl bg-bg-secondary/40 dark:bg-white/5 border border-border-light dark:border-white/10 transition-all duration-300 hover:shadow-theme-lg group">
            <div className="flex items-center gap-4 mb-6">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-500 text-white shadow-theme-sm group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="relative p-8 rounded-3xl bg-bg-secondary/40 dark:bg-white/5 border border-border-light dark:border-white/10 transition-all duration-300 hover:shadow-theme-lg group">
            <div className="flex items-center gap-4 mb-6">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-600 text-white shadow-theme-sm group-hover:scale-110 transition-transform duration-300">
