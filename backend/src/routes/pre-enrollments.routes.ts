...
import {
  validateCreatePreEnrollmentPeriodWithTypeDates,
  validateUpdatePreEnrollmentPeriod,
...
router.patch('/:id/withdraw', requirePermission('enrollments:edit'), preEnrollmentsController.withdrawPreEnrollment);
