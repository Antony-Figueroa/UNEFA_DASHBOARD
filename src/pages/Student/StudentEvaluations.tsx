...
export default function StudentEvaluations() {
  ...
  if (loading) {
    return (
      <>
        <PageMeta title="Mis Evaluaciones | UNEFA" description="Ver mis evaluaciones de práctica profesional" />
  ...
  return (
    <>
      <PageMeta title="Mis Evaluaciones | UNEFA" description="Ver mis evaluaciones de práctica profesional" />
      <PageBreadcrumb pageTitle="Mis Evaluaciones" />
      ...
      <div className="space-y-6">
        <div className="mb-6">
          ...
          <p className="text-text-secondary dark:text-text-tertiary mt-1">
            Consulta el estado y resultados de tus evaluaciones de práctica profesional
          </p>
        </div>
