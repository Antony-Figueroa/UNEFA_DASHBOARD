...
const AppHeader: React.FC = () => {
  ...
  return (
    <header 
      ...
      className="sticky top-0 flex w-full bg-white/95 backdrop-blur-sm border-b border-border-light/50 z-40 dark:border-white/5 dark:bg-bg-dark/95 transition-all duration-300"
    >
          ...
          <div className="hidden lg:block flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                ...
                type="text"
                placeholder="Buscar..."
                className="h-10 w-full rounded-xl border border-border-light/50 bg-gray-50/50 py-2 pl-10 pr-4 text-sm text-text-primary placeholder:text-text-tertiary focus:outline-none focus:border-brand-300 focus:bg-white focus:ring-2 focus:ring-brand-500/10 transition-all duration-200 dark:border-white/10 dark:bg-white/[0.03] dark:text-white dark:placeholder:text-white/30 dark:focus:border-brand-500 dark:focus:bg-white/[0.05]"
              />
