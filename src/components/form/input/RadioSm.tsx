...
const RadioSm: React.FC<RadioProps> = ({
  ...
  return (
    <label
      htmlFor={id}
      className={`flex cursor-pointer select-none items-center text-sm text-text-tertiary dark:text-text-tertiary ${className}`}
    >
        ...
        >
          ...
          <span
            className={`h-1.5 w-1.5 rounded-full ${
              checked ? "bg-white" : "bg-white dark:bg-bg-dark"
            }`}
          ></span>
        </span>
      </span>
