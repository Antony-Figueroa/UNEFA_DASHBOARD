      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.institutionalHeader}>
          ...
          <View style={styles.institutionalTextContainer}>
            ...
            <Text style={styles.institutionalText}>VICERRECTORADO DE LA REGIÓN LOS LLANOS</Text>
            <Text style={styles.institutionalText}>NÚCLEO PORTUGUESA EXTENSIÓN ACARIGUA</Text>
            <Text style={styles.institutionalText}>EQUIPO DE TRABAJO DE PRÁCTICAS PROFESIONALES</Text>
          </View>
