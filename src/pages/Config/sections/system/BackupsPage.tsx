...
import { SkeletonLoader, TablePageSkeleton } from "@/components/ui/skeleton";
    ...
    <>
      ...
      <div className="space-y-6 animate-fadeIn">
        ...
        <ComponentCard title="Lista de Respaldos">
          <SkeletonLoader isLoading={loading} skeleton={<TablePageSkeleton rows={3} />} id="backups-skeleton">
            {backups.length === 0 ? (
