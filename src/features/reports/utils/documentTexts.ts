...
Constancia que se expide a petición de parte interesada, en Guanare, a los {{dia}} días del mes de {{mes}} del {{anio}}.`,
  ...
  evaluacion_consolidada: {
    comiteFirma1Nombre: '',
    comiteFirma1Cargo: 'Coordinador de Práctica Profesional',
    comiteFirma2Nombre: '',
    comiteFirma2Cargo: 'Coordinador de Carrera',
    comiteFirma3Nombre: '',
    comiteFirma3Cargo: 'Tutor Académico',
    academicoFirmaNombre: '',
    academicoFirmaCargo: 'Tutor Académico',
    institucionalFirmaNombre: '',
    institucionalFirmaCargo: 'Tutor(a) Institucional',
    firma1Nombre: '',
    ...
    firma5Orden: 'Según Orden administrativa N° 0005 de fecha 18 de Marzo 2022',
  },
