      ...
      >
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-border-light dark:border-white/10">
          <li>
            <DropdownItem
              ...
              tag="a"
              to="/profile"
              className="px-3 py-2 font-medium text-text-primary rounded-lg group text-theme-sm hover:bg-brand-500 hover:text-white dark:text-text-tertiary dark:hover:bg-brand-500 dark:hover:text-white transition-colors duration-200"
              icon={
                <svg
                  className="fill-text-secondary group-hover:fill-white dark:fill-text-tertiary dark:group-hover:fill-white size-5"
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
        ...
        <div className="mt-3">
          <DropdownItem
            ...
            className="px-3 py-2 font-medium rounded-lg text-text-primary group text-theme-sm hover:bg-brand-500 hover:text-white dark:text-text-tertiary dark:hover:bg-brand-500 dark:hover:text-white transition-colors duration-200"
            icon={
              <svg
                className="fill-text-secondary group-hover:fill-white dark:group-hover:fill-white size-5"
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
